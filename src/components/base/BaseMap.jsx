...
const tinyGeoUrl =
  'https://raw.githubusercontent.com/nvkelso/natural-earth-vector/ca96624a56bd078437bca8184e78163e5039ad19/geojson/ne_50m_admin_0_tiny_countries.geojson';
    ...
    <div className={`base-map ${className}`}>
      ...
      >
        ...
        {additionalControls.map((control, index) => (
          <React.Fragment key={`control-${index}`}>{control}</React.Fragment>
        ))}
      </div>
      <ComposableMap
