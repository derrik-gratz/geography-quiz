...
export function CollapsibleContainer({ content, title, classNames = '', defaultCollapsed = false }) {
    ...
    return (
        <div className={`collapsable-container ${classNames} ${isCollapsed ? 'collapsable-container_collapsed' : ''}`}>
            <div className="collapsable-container__title">
                ...
                {!isCollapsed && (
                    <div className="collapsable-container__content">
                        {content}
                    </div>
                )}
            </div>
